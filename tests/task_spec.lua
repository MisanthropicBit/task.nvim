...
describe("task #task", function()
    ...
    it(
        "creates and starts a task and waits for it to finish",
        async(function()
            local task = Task.new(function()
                Task.sleep(500)
            end)
    ...
    it("runs a task that fails", function() end)

    it("runs a task that is cancelled", function() end)

    it("runs a task that times out", function() end)

    it("runs multiple tasks and waits for them to finish", function() end)

    it("runs multiple tasks and gets the result of the first one to finish", function() end)
end)
